...
- `src/language/` — AST definitions: modules, imports, items (functions, variables, constants,
  structs), expressions, statements
- `src/validators/` — Semantic validation passes (types, identifiers, imports, literals, circular
  deps)
